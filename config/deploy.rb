...
set :user,            'deployer'
set :repo_url,        'git@github.com:henroca/FARMA.git'
set :keep_releases,   3

set :puma_threads,    [4, 16] # Min and Max threads per worker

set :nvm_type, :user
set :nvm_node, 'v10.17.0'
...
production:
  ...
  db.host: localhost
  mailer.host: farma.tsi.pro.br
  mailer.port: '80'
  mailer.from: 'noreply.farma@gmail.com'
  mailer.smtp: 'smtp.gmail.com'
  mailer.smtp.port: '587'
  mailer.smtp.domain: 'farma.tsi.pro.br'
